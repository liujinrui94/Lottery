 ...
 * @time: 2017/12/22 14:04
 * @description:
 */
public class BaseWebViewToobarActivity extends AppCompatActivity implements NetEventInterface {
    ...
    @BindView(R.id.activity_base_web_toolbar_view)
    WebView webView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base_web_view_toolbar);
        progressShow();
    }
    ...
    protected void initToolbar(String title, final BaseWebViewToobarActivity context, boolean back) {
